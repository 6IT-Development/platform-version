...
Here you will find all the important new features and release notes of the Platform Version 2026.1 release.

## Most Important New Features

### OpenSearch and Elasticsearch support

Based on community feedback and recent changes in Elasticsearch's licensing policy, Platform Version 2026.1 will support
...
Starting with Platform Version 2026.1, both TinyMCE and Quill will be supported, but TinyMCE will be
...
With Pimcore Version 2026.1 Pimcore allows developers to optionally use symfony/flex and so install third party
