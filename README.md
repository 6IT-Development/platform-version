...
# SIX-IT Pimcore Platform Version
...
- Update **bugfix** versions of modules
    ...
    - For example: within `2026.1` it can install `six-it/pimcore-source:1.0.1` and `six-it/pimcore-source:1.0.2` as soon as it is
      released, but not `pimcore/pimcore:1.1.0`.
